var Trajectory = function () {
  'use strict';
  var data = {trajectory: null, wind: null, solar: null, current: null,
      min: null, max: null, dt: null},
    dt = [],
    width = 700,
    height = 350,
...
//    console.log(JSON.stringify(_data));
  ...
  function trajectory_graph(_s) {
    ...
    handles = handle_layer.selectAll('.time-period')
      ...
      .attr('transform', function(d) { return 'translate(' + (x(d.date) - time_period_width / 2) + ',0)'; });
    handles.each(function(d, i) {
      ...
      d3.select(this).append('circle')
        .classed('data-point', function(d) { return (d.date.getFullYear() > 2013); })
